            ...
            <div className="bg-white rounded-xl shadow-sm p-6 space-y-6 sticky top-8">
              ...
              <div className="border-t border-gray-200 pt-4 space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">Rs. {cartSummary.subtotal || "0"}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Shipping</span>
                  <span className="font-medium">Rs. {cartSummary.shippingFee}</span>
                </div>
                <div className="flex justify-between border-t border-gray-200 pt-4">
                  <span className="text-lg font-semibold">Total</span>
                  <span className="text-lg font-semibold">Rs. {cartSummary.total}</span>
                </div>
              </div>
            </div>
          </div>
